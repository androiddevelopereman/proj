...
const routes = [
  ...
  { path: '/charts', name: 'Charts', component: Charts ,meta: { title: 'Charts' }  },
  { path: '/columnchart', name: 'ColumnChart', component: ColumnChart ,meta: { title: 'ColumnChart' }  },
  { path: '/barchart', name: 'BarChart', component: BarChart ,meta: { title: 'BarChart' }  },
